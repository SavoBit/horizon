...
from openstack_dashboard.dashboards.project.connections.\
    troubleshoot import forms as project_forms
from openstack_dashboard.dashboards.project.connections.\
    troubleshoot import workflows as project_workflows
...
class AllocateView(forms.ModalFormView):
    ...
    template_name = 'project/connections/troubleshoot/allocate.html'
