...
class AllocateIP(tables.LinkAction):
    ...
    url = "horizon:project:connections:troubleshoot:allocate"

    def single(self, data_table, request, *args):
        return shortcuts.redirect('horizon:project:connections:index')
...
class AssociateIP(tables.LinkAction):
    ...
    url = "horizon:project:connections:troubleshoot:associate"
