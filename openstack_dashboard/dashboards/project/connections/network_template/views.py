...
class DetailView(tables.DataTableView):
    ...
    template_name = 'project/connections/network_template/detail.html'
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'project/connections/network_template/update.html'
...
class AddRuleView(forms.ModalFormView):
    ...
    template_name = 'project/connections/network_template/add_rule.html'

    def get_success_url(self):
        sg_id = self.kwargs['security_group_id']
        return reverse("horizon:project:connections:"
